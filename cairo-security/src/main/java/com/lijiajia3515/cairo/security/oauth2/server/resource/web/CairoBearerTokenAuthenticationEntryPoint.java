package com.lijiajia3515.cairo.security.oauth2.server.resource.web;
...
public class CairoBearerTokenAuthenticationEntryPoint implements AuthenticationEntryPoint {
	@Getter
	@Setter
